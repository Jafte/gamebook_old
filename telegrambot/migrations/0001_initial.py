    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('state', models.CharField(choices=[('menu', 'in main menu'), ('game', 'in game')], max_length=20)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('is_bot', models.BooleanField(default=False, verbose_name='Is user a Bot')),
                ('language_code', models.CharField(blank=True, max_length=255, null=True, verbose_name='Langiage code')),
